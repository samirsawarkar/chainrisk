...
class TwitterSimulationRunner:
    ...
    def _create_model(self):
        """Gemini(OpenAI ), GEMINI_MODEL_OASIS_TWITTER."""
        from app.config import Config

        Config.apply_oasis_llm_env()
        llm_model = (
            os.environ.get("GEMINI_MODEL_OASIS_TWITTER")
            or self.config.get("llm_model")
            or Config.GEMINI_MODEL_OASIS_TWITTER
        )
        print(f"Gemini OASIS (Twitter): model={llm_model}...")
