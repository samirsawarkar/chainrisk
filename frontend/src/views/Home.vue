<template>
  <div class="home-container">
    <!-- Top nav -->
    <nav class="navbar">
      <div class="nav-brand">CHAINRISK</div>
      <div class="nav-links">
        <LanguageSwitcher />
        <button class="github-link" @click="router.push('/supply-chain')">
          Supply Chain Project <span class="arrow">↗</span>
        </button>
        <a href="https://github.com/samirsawarkar/chainrisk" target="_blank" class="github-link">
      ...
      <section class="hero-section">
        ...
        <div class="hero-right">
          ...
          <div class="logo-container">
            <img src="../assets/logo/ChainRisk_logo_left.jpeg" alt="ChainRisk Logo" class="hero-logo" />
          </div>
        ...
        <div class="right-panel">
          <div class="console-box">
            ...
            <div class="console-section btn-section">
              ...
              <p v-if="!loading && !canSubmit" class="cta-hint">{{ $t('home.ctaHint') }}</p>
            </div>
          </div>
        </div>
      </section>
...
/** Queue files + brief, then open graph build (API runs in Process / MainView). */
...
<style scoped>
/* Theme tokens (fonts loaded in index.html) */
:root {
  --black: #000000;
  --white: #FFFFFF;
  --orange: #FF4500;
  ...
  --border: #E5E5E5;
  /*
   * Headings: Space Grotesk; code / labels: JetBrains Mono
   */
...
.console-box {
  ...
  padding: 8px; /* inset for double-frame look */
}
